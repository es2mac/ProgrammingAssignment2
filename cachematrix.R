...
## cacheSolve takes a cached matrix created by makeCacheMatrix and
## return its inverse
...
## cacheSolve calculates the inverse of a matrix, using makeCacheMatrix
## to "cache" the inverse.  That is, if the inverse had been calculated
## previously, then get the saved inverse and return it.
##
## Usage example:
##	m <- makeCacheMatrix(...)
##	cacheSolve(m)
